...
const messages = {
  en: {
    ...
    recordingTruncatedWarning: 'This recording is {missing} s shorter than the session that was recorded ({produced} s saved of {expected} s). Part of the audio did not make it into the file. Please check the recording before relying on it.',
    privacy: 'Privacy Policy',
    terms: 'Terms of Service',
    uploadCancelled: 'Upload cancelled.',
    chunkSaveWarning: 'Audio chunks are failing to save. Recording data may be lost — check available storage.',
    recordingErrorOccurred: "The recorder stopped because of an error: {message}. Previously saved audio is retained. Check History for the recovery result.",
    systemAudioWrongOutputDevice: 'System audio is captured from "{defaultDevice}", but Windows sends call audio to "{commsDevice}". Open Windows sound settings and make "{commsDevice}" the default output device — otherwise only your microphone is recorded.',
    systemAudioSilentWarning: 'No system audio has arrived for {seconds} s — the other participants are probably NOT being recorded. Check that your meeting plays through the Windows default output device.',
    ...
    safetyNetDiskFullStop: "Your disk is full. Recording is stopping. Previously saved audio is retained; the latest audio may not have been saved. Free disk space and check History.",
    safetyNetChunkFailStop: "Audio cannot be saved. Recording is stopping. Keep the app open to retry saving the remaining audio, and check History.",
    ...
    captureWarningMergeDegraded: 'Your microphone and system audio are saved on this device, but could not be combined. Please retry saving the recording.',
    captureWarningSystemAudioSilent: "No system audio has arrived for {seconds} s — the other participants are probably NOT being recorded. Check that your meeting app is playing through your Mac's default output device (Zoom, Teams and Slack each have their own speaker setting).",
    captureWarningSystemAudioRestored: 'System audio is being captured again.',
    ok: 'OK',
    recordingRecoveredMsg: 'Recovered {count} interrupted recording(s).',
    recordingRecoveredCaption: "Check the recovered recording in History. Audio from the interruption may be missing.",
    uploadKeptLocally: 'Your recording is saved on this computer and will retry automatically — you can also retry it from History.',
    uploadTooLarge: 'This recording is too large to upload, but it is saved on this computer. Please contact support.',
    ...
    recordingUploadRetry: 'Retrying upload ({attempt})...',
    ...
    unsavedAudioMessage: 'Some audio is still only in memory. Keep the app open, free disk space and retry saving. Discarding this recording will permanently lose that audio.',
    ...
    captureRecoveryFailedMsg: "Recording could not resume automatically. Previously saved audio is retained. Check the recording for gaps before relying on it.",
  ...
  de: {
    ...
    recordingTruncatedWarning: 'Diese Aufnahme ist {missing} s kürzer als die aufgezeichnete Sitzung ({produced} s von {expected} s gespeichert). Ein Teil des Tons fehlt in der Datei. Bitte prüfen Sie die Aufnahme, bevor Sie sich darauf verlassen.',
    privacy: 'Datenschutz',
    terms: 'Nutzungsbedingungen',
    uploadCancelled: 'Upload abgebrochen.',
    chunkSaveWarning: 'Audio-Blöcke können nicht gespeichert werden. Aufnahmedaten könnten verloren gehen — prüfen Sie den freien Speicherplatz.',
    recordingErrorOccurred: "Die Aufnahme wurde wegen eines Fehlers gestoppt: {message}. Bereits gespeichertes Audio bleibt erhalten. Prüfen Sie das Ergebnis der Wiederherstellung im Verlauf.",
    systemAudioWrongOutputDevice: 'Systemaudio wird von "{defaultDevice}" aufgenommen, Windows gibt den Ton von Anrufen aber auf "{commsDevice}" aus. Legen Sie in den Windows-Soundeinstellungen "{commsDevice}" als Standard-Ausgabegerät fest — sonst wird nur Ihr Mikrofon aufgenommen.',
    systemAudioSilentWarning: 'Seit {seconds} s kommt kein Systemaudio an — die anderen Teilnehmenden werden vermutlich NICHT aufgenommen. Prüfen Sie, ob das Meeting über das Windows-Standard-Ausgabegerät läuft.',
    ...
    safetyNetDiskFullStop: "Ihre Festplatte ist voll. Die Aufnahme wird gestoppt. Bereits gespeichertes Audio bleibt erhalten; das neueste Audio wurde möglicherweise nicht gespeichert. Geben Sie Speicherplatz frei und prüfen Sie den Verlauf.",
    safetyNetChunkFailStop: "Audio kann nicht gespeichert werden. Die Aufnahme wird gestoppt. Lassen Sie die App für einen erneuten Speicherversuch geöffnet und prüfen Sie den Verlauf.",
    ...
    captureWarningMergeDegraded: 'Mikrofon- und Systemaudio sind auf diesem Gerät gespeichert, konnten aber nicht zusammengeführt werden. Bitte versuchen Sie erneut, die Aufnahme zu speichern.',
    captureWarningSystemAudioSilent: 'Seit {seconds} s kommt kein Systemaudio an — die anderen Teilnehmenden werden vermutlich NICHT aufgenommen. Prüfen Sie, ob Ihre Meeting-App über das Standard-Ausgabegerät des Macs läuft (Zoom, Teams und Slack haben je eine eigene Lautsprecher-Einstellung).',
    captureWarningSystemAudioRestored: 'Systemaudio wird wieder aufgenommen.',
    ok: 'OK',
    recordingRecoveredMsg: '{count} unterbrochene Aufnahme(n) wiederhergestellt.',
    recordingRecoveredCaption: "Prüfen Sie die wiederhergestellte Aufnahme im Verlauf. Während der Unterbrechung kann Audio fehlen.",
    uploadKeptLocally: 'Deine Aufnahme ist auf diesem Computer gespeichert und wird automatisch erneut versucht — du kannst sie auch im Verlauf erneut hochladen.',
    uploadTooLarge: 'Diese Aufnahme ist zu groß zum Hochladen, aber sie ist auf diesem Computer gespeichert. Bitte kontaktiere den Support.',
    ...
    recordingStopping: 'Wird beendet...',
    recordingError: 'Ein Fehler ist aufgetreten',
    recordingUploadRetry: 'Upload wird wiederholt ({attempt})...',
    ...
    unsavedAudioMessage: 'Ein Teil der Aufnahme ist nur im Arbeitsspeicher. Lassen Sie die App geöffnet, schaffen Sie Speicherplatz und speichern Sie erneut. Beim Verwerfen geht dieses Audio unwiderruflich verloren.',
    ...
    captureRecoveryFailedMsg: "Die Aufnahme konnte nicht automatisch fortgesetzt werden. Bereits gespeichertes Audio bleibt erhalten. Prüfen Sie die Aufnahme auf Lücken.",
  ...
  fr: {
    ...
    recordingTruncatedWarning: "Cet enregistrement est plus court de {missing} s que la session enregistrée ({produced} s sur {expected} s). Une partie de l'audio ne figure pas dans le fichier. Vérifiez l'enregistrement avant de vous y fier.",
    privacy: 'Confidentialité',
    terms: "Conditions d'utilisation",
    uploadCancelled: 'Envoi annulé.',
    chunkSaveWarning: "Les blocs audio ne peuvent pas être enregistrés. Des données pourraient être perdues — vérifiez l'espace disponible.",
    recordingErrorOccurred: "L’enregistrement s’est arrêté à cause d’une erreur : {message}. L’audio déjà sauvegardé est conservé. Consultez le résultat de la récupération dans l’historique.",
    systemAudioWrongOutputDevice: "L'audio système est capturé depuis « {defaultDevice} », mais Windows envoie le son des appels vers « {commsDevice} ». Dans les paramètres de son Windows, définissez « {commsDevice} » comme périphérique de sortie par défaut — sinon seul votre microphone est enregistré.",
    systemAudioSilentWarning: "Aucun audio système depuis {seconds} s — les autres participants ne sont probablement PAS enregistrés. Vérifiez que la réunion passe par le périphérique de sortie par défaut de Windows.",
    ...
    safetyNetDiskFullStop: "Votre disque est plein. L’enregistrement s’arrête. L’audio déjà enregistré est conservé ; les derniers instants peuvent manquer. Libérez de l’espace et consultez l’historique.",
    safetyNetChunkFailStop: "Impossible de sauvegarder l’audio. L’enregistrement s’arrête. Gardez l’application ouverte pour réessayer et consultez l’historique.",
    ...
    captureWarningMergeDegraded: 'Le microphone et l\'audio système sont enregistrés sur cet appareil, mais n\'ont pas pu être combinés. Veuillez réessayer de sauvegarder l\'enregistrement.',
    captureWarningSystemAudioSilent: "Aucun audio système depuis {seconds} s — les autres participants ne sont probablement PAS enregistrés. Vérifiez que votre application de réunion passe par le périphérique de sortie par défaut du Mac (Zoom, Teams et Slack ont chacun leur propre réglage de haut-parleur).",
    captureWarningSystemAudioRestored: "L'audio système est de nouveau capturé.",
    ok: 'OK',
    recordingRecoveredMsg: '{count} enregistrement(s) interrompu(s) récupéré(s).',
    recordingRecoveredCaption: "Vérifiez l’enregistrement récupéré dans l’historique. L’audio pendant l’interruption peut manquer.",
    uploadKeptLocally: 'Votre enregistrement est sauvegardé sur cet ordinateur et sera réessayé automatiquement — vous pouvez aussi le renvoyer depuis l\'Historique.',
    uploadTooLarge: 'Cet enregistrement est trop volumineux pour être envoyé, mais il est sauvegardé sur cet ordinateur. Veuillez contacter le support.',
    ...
    recordingStopping: 'Arrêt en cours...',
    recordingError: 'Une erreur est survenue',
    recordingUploadRetry: 'Nouvelle tentative de téléchargement ({attempt})...',
    ...
    unsavedAudioMessage: "Une partie de l’audio est encore uniquement en mémoire. Gardez l’application ouverte, libérez de l’espace et réessayez de sauvegarder. Supprimer cet enregistrement perdra définitivement cet audio.",
    ...
    captureRecoveryFailedMsg: "L’enregistrement n’a pas pu reprendre automatiquement. L’audio déjà sauvegardé est conservé. Vérifiez si des passages manquent.",
  ...
  it: {
    ...
    recordingTruncatedWarning: "Questa registrazione è più corta di {missing} s rispetto alla sessione registrata ({produced} s su {expected} s). Parte dell'audio non è finita nel file. Verifica la registrazione prima di farci affidamento.",
    privacy: 'Privacy',
    terms: 'Termini di servizio',
    uploadCancelled: 'Caricamento annullato.',
    chunkSaveWarning: 'Impossibile salvare i blocchi audio. I dati della registrazione potrebbero andare persi — controlla lo spazio disponibile.',
    recordingErrorOccurred: "La registrazione si è fermata per un errore: {message}. L’audio già salvato è conservato. Controlla il risultato del recupero nella cronologia.",
    systemAudioWrongOutputDevice: "L'audio di sistema viene catturato da «{defaultDevice}», ma Windows invia l'audio delle chiamate a «{commsDevice}». Nelle impostazioni audio di Windows imposta «{commsDevice}» come dispositivo di output predefinito — altrimenti verrà registrato solo il microfono.",
    systemAudioSilentWarning: "Da {seconds} s non arriva alcun audio di sistema — gli altri partecipanti probabilmente NON vengono registrati. Verifica che la riunione passi dal dispositivo di output predefinito di Windows.",
    ...
    safetyNetDiskFullStop: "Il disco è pieno. La registrazione si sta fermando. L’audio già salvato è conservato; gli ultimi istanti potrebbero mancare. Libera spazio e controlla la cronologia.",
    safetyNetChunkFailStop: "Impossibile salvare l’audio. La registrazione si sta fermando. Tieni aperta l’app per riprovare il salvataggio e controlla la cronologia.",
    ...
    captureWarningMergeDegraded: 'L\'audio del microfono e di sistema è salvato su questo dispositivo, ma non è stato possibile combinarlo. Riprova a salvare la registrazione.',
    captureWarningSystemAudioSilent: "Da {seconds} s non arriva alcun audio di sistema — gli altri partecipanti probabilmente NON vengono registrati. Verifica che l'app della riunione passi dal dispositivo di output predefinito del Mac (Zoom, Teams e Slack hanno ciascuna la propria impostazione altoparlante).",
    captureWarningSystemAudioRestored: "L'audio di sistema viene nuovamente acquisito.",
    ok: 'OK',
    recordingRecoveredMsg: '{count} registrazione/i interrotta/e recuperata/e.',
    recordingRecoveredCaption: "Controlla la registrazione recuperata nella cronologia. L’audio durante l’interruzione potrebbe mancare.",
    uploadKeptLocally: 'La tua registrazione è salvata su questo computer e verrà riprovata automaticamente — puoi anche riprovare dalla Cronologia.',
    uploadTooLarge: 'Questa registrazione è troppo grande per essere caricata, ma è salvata su questo computer. Contatta il supporto.',
    ...
    recordingStopping: 'Arresto in corso...',
    recordingError: 'Si è verificato un errore',
    recordingUploadRetry: 'Nuovo tentativo di caricamento ({attempt})...',
    ...
    unsavedAudioMessage: 'Parte dell’audio è ancora solo in memoria. Tieni aperta l’app, libera spazio e riprova a salvare. Eliminando questa registrazione, perderai definitivamente questo audio.',
    ...
    captureRecoveryFailedMsg: "La registrazione non è ripresa automaticamente. L’audio già salvato è conservato. Controlla se mancano dei passaggi.",
