...
const messages = {
  en: {
    ...
    recordingErrorTitle: 'Something went wrong',
    recordingErrorMessage: 'The recording could not be saved correctly. You can try again — your audio data is still stored locally.',
    retrySaving: 'Retry',
  ...
  de: {
    ...
    recordingErrorTitle: 'Etwas ist schiefgelaufen',
    recordingErrorMessage: 'Die Aufnahme konnte nicht korrekt gespeichert werden. Sie können es erneut versuchen — Ihre Audiodaten sind weiterhin lokal gespeichert.',
  ...
  fr: {
    ...
    recordingErrorTitle: 'Un problème est survenu',
    recordingErrorMessage: "L'enregistrement n'a pas pu être sauvegardé correctement. Vous pouvez réessayer — vos données audio sont toujours stockées localement.",
  ...
  it: {
    ...
    recordingErrorTitle: 'Qualcosa è andato storto',
    recordingErrorMessage: 'La registrazione non è stata salvata correttamente. Puoi riprovare — i tuoi dati audio sono ancora memorizzati localmente.',
    retrySaving: 'Riprova',
