...
const messages = {
  en: {
    ...
    recordingErrorOccurred: 'The recorder stopped because of an error: {message}. Everything captured so far has been saved — please start a new recording.',
    ...
    recordingRecoveredCaption: 'Your audio was saved and is now uploading.',
    ...
    minutesLimitWarning: 'Only {minutes} minute(s) of credit left — this recording will still be saved in full',
  ...
  de: {
    ...
    recordingErrorOccurred: 'Die Aufnahme wurde wegen eines Fehlers gestoppt: {message}. Alles bisher Aufgenommene wurde gespeichert — bitte starten Sie eine neue Aufnahme.',
    ...
    recordingRecoveredCaption: 'Deine Aufnahme wurde gespeichert und wird jetzt hochgeladen.',
    ...
    minutesLimitWarning: 'Nur noch {minutes} Minute(n) Guthaben – diese Aufnahme wird trotzdem vollständig gespeichert',
  ...
  fr: {
    ...
    recordingErrorOccurred: "L'enregistrement s'est arrêté à cause d'une erreur : {message}. Tout ce qui a été capturé est sauvegardé — veuillez démarrer un nouvel enregistrement.",
    ...
    recordingRecoveredCaption: 'Votre audio a été sauvegardé et est en cours d\'envoi.',
    ...
    minutesLimitWarning: 'Plus que {minutes} minute(s) de crédit – cet enregistrement sera tout de même sauvegardé en entier',
  ...
  it: {
    ...
    recordingErrorOccurred: "La registrazione si è interrotta per un errore: {message}. Tutto ciò che è stato acquisito è stato salvato — avvia una nuova registrazione.",
    ...
    recordingRecoveredCaption: 'Il tuo audio è stato salvato ed è ora in fase di caricamento.',
    ...
    minutesLimitWarning: 'Solo {minutes} minuto/i di credito rimanenti – questa registrazione verrà comunque salvata per intero',
